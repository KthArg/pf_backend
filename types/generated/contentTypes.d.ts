...
export interface ApiClassClass extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'The gym class offering';
    displayName: 'Class';
    pluralName: 'classes';
    singularName: 'class';
  };
...
export interface ApiHomeSettingHomeSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    classesPerWeek: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerCtaSubtitle: Schema.Attribute.Text;
    footerCtaTitle: Schema.Attribute.String;
    gymAddress: Schema.Attribute.String;
    gymEmail: Schema.Attribute.String;
    gymHours: Schema.Attribute.Text;
    gymName: Schema.Attribute.String;
    gymPhone: Schema.Attribute.String;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-setting.home-setting'
    > &
      Schema.Attribute.Private;
    membersCount: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    trainersCount: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTrainerTrainer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Gym trainers and coaches';
    displayName: 'Trainer';
    pluralName: 'trainers';
